import { isHidden, getBoundingClientRect, getUrl, prepareUrl, isElemType, ElemTypes, } from './dom-utils';
...
export const elementToFigma = (el, pseudo) => {
    ...
    if (computedStyle.boxShadow && computedStyle.boxShadow !== 'none') {
        ...
        const hasShadowSpread = parsed.findIndex(({ spreadRadius }) => Boolean(spreadRadius)) !==
            -1;
